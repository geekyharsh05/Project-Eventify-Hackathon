...
<html lang="en">
  <head>
    ...
    <title>Eventify - Privacy Policy</title>
    <link rel="stylesheet" type="text/css" href="PrivacyPolicy.css" />
  </head>
  <body>
    <!-- Header starts here -->
    <header>
        <div class="logo" href="/">Eventify</div>
        <nav class="navbar">
    ...
    <main>
      ...
      <p>
        This privacy policy discloses the privacy practices for Eventify
        website. This privacy policy applies solely to information collected by
      ...
      <p>
        ...
        looking for "https" at the beginning of the address of the Web
      </p>
    </main>
    <footer>
